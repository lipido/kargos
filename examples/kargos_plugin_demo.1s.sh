...
echo "Dropdown item 2 $(date +\"%T\") (bash, imageURL, onclick=bash, terminal=true) | terminal=true bash=ls onclick=bash imageURL=http://doc.qt.io/qt-5/images/declarative-qtlogo.png"
